...
import com.mocity.rom.DropTarget.DragObject;
import com.mocity.rom.LauncherSettings.Favorites;
import com.mocity.rom.accessibility.LauncherAccessibilityDelegate;
import com.mocity.rom.allapps.AllAppsContainerView;
import com.mocity.rom.allapps.PredictiveAppsProvider;
import com.mocity.rom.allapps.AllAppsTransitionController;
import com.mocity.rom.allapps.DefaultAppSearchController;
import com.mocity.rom.anim.AnimationLayerSet;
import com.mocity.rom.compat.AppWidgetManagerCompat;
import com.mocity.rom.compat.LauncherAppsCompat;
import com.mocity.rom.compat.PinItemRequestCompat;
import com.mocity.rom.config.FeatureFlags;
import com.mocity.rom.config.ProviderConfig;
import com.mocity.rom.dragndrop.DragController;
import com.mocity.rom.dragndrop.DragLayer;
import com.mocity.rom.dragndrop.DragOptions;
import com.mocity.rom.dragndrop.DragView;
import com.mocity.rom.dragndrop.PinItemDragListener;
import com.mocity.rom.dynamicui.ExtractedColors;
import com.mocity.rom.folder.Folder;
import com.mocity.rom.folder.FolderIcon;
import com.mocity.rom.keyboard.CustomActionsPopup;
import com.mocity.rom.keyboard.ViewGroupFocusHelper;
import com.mocity.rom.logging.FileLog;
import com.mocity.rom.logging.UserEventDispatcher;
import com.mocity.rom.model.ModelWriter;
import com.mocity.rom.model.PackageItemInfo;
import com.mocity.rom.model.WidgetItem;
import com.mocity.rom.notification.NotificationListener;
import com.mocity.rom.pageindicators.PageIndicator;
import com.mocity.rom.popup.PopupContainerWithArrow;
import com.mocity.rom.popup.PopupDataProvider;
import com.mocity.rom.shortcuts.DeepShortcutManager;
import com.mocity.rom.shortcuts.ShortcutKey;
import com.mocity.rom.userevent.nano.LauncherLogProto;
...
import com.mocity.rom.util.ActivityResultInfo;
import com.mocity.rom.util.ComponentKey;
import com.mocity.rom.util.ItemInfoMatcher;
import com.mocity.rom.util.MultiHashMap;
import com.mocity.rom.util.PackageManagerHelper;
import com.mocity.rom.util.PackageUserKey;
import com.mocity.rom.util.PendingRequestArgs;
import com.mocity.rom.util.TestingUtils;
import com.mocity.rom.util.Thunk;
import com.mocity.rom.util.ViewOnDrawExecutor;
import com.mocity.rom.widget.PendingAddShortcutInfo;
import com.mocity.rom.widget.PendingAddWidgetInfo;
import com.mocity.rom.widget.WidgetAddFlowHandler;
import com.mocity.rom.widget.WidgetHostViewLoader;
import com.mocity.rom.widget.WidgetsContainerView;
...
public class Launcher extends BaseActivity
    ...
    static final String INTENT_EXTRA_IGNORE_LAUNCH_ANIMATION =
            "com.mocity.rom.intent.extra.shortcut.INGORE_LAUNCH_ANIMATION";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (PackageManagerHelper.isAppEnabled(getPackageManager(), "com.android.quicksearchbox"))
   ...
   public void tryAndUpdatePredictedApps() {
    ...
    /**
     * $ adb shell dumpsys activity com.mocity.rom.Launcher [--all]
     */
    @Override
