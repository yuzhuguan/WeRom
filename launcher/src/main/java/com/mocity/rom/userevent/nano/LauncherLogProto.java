package com.mocity.rom.userevent.nano;
...
public interface LauncherLogProto {
    ...
    public static final class Target extends
        ...
        public Target clear() {
            type = com.mocity.rom.userevent.nano.LauncherLogProto.Target.Type.NONE;
            pageIndex = 0;
            rank = 0;
            gridX = 0;
            gridY = 0;
            containerType = com.mocity.rom.userevent.nano.LauncherLogProto.ContainerType.DEFAULT_CONTAINERTYPE;
            cardinality = 0;
            controlType = com.mocity.rom.userevent.nano.LauncherLogProto.ControlType.DEFAULT_CONTROLTYPE;
            itemType = com.mocity.rom.userevent.nano.LauncherLogProto.ItemType.DEFAULT_ITEMTYPE;
            packageNameHash = 0;
            componentHash = 0;
            intentHash = 0;
            spanX = 1;
        ...
        public void writeTo(com.google.protobuf.nano.CodedOutputByteBufferNano output)
            ...
            if (this.type != com.mocity.rom.userevent.nano.LauncherLogProto.Target.Type.NONE) {
            ...
            if (this.containerType != com.mocity.rom.userevent.nano.LauncherLogProto.ContainerType.DEFAULT_CONTAINERTYPE) {
                output.writeInt32(6, this.containerType);
            }
            if (this.cardinality != 0) {
                output.writeInt32(7, this.cardinality);
            }
            if (this.controlType != com.mocity.rom.userevent.nano.LauncherLogProto.ControlType.DEFAULT_CONTROLTYPE) {
                output.writeInt32(8, this.controlType);
            }
            if (this.itemType != com.mocity.rom.userevent.nano.LauncherLogProto.ItemType.DEFAULT_ITEMTYPE) {
            ...
            while (true) {
                ...
                switch (tag) {
                    ...
                    case 8: {
                        ...
                        switch (value) {
                            case com.mocity.rom.userevent.nano.LauncherLogProto.Target.Type.NONE:
                            case com.mocity.rom.userevent.nano.LauncherLogProto.Target.Type.ITEM:
                            case com.mocity.rom.userevent.nano.LauncherLogProto.Target.Type.CONTROL:
                            case com.mocity.rom.userevent.nano.LauncherLogProto.Target.Type.CONTAINER:
                                this.type = value;
                                break;
                        }
                        break;
                    ...
                    case 48: {
                        int value = input.readInt32();
                        switch (value) {
                            case com.mocity.rom.userevent.nano.LauncherLogProto.ContainerType.DEFAULT_CONTAINERTYPE:
                            case com.mocity.rom.userevent.nano.LauncherLogProto.ContainerType.WORKSPACE:
                            case com.mocity.rom.userevent.nano.LauncherLogProto.ContainerType.HOTSEAT:
                            case com.mocity.rom.userevent.nano.LauncherLogProto.ContainerType.FOLDER:
                            case com.mocity.rom.userevent.nano.LauncherLogProto.ContainerType.ALLAPPS:
                            case com.mocity.rom.userevent.nano.LauncherLogProto.ContainerType.WIDGETS:
                            case com.mocity.rom.userevent.nano.LauncherLogProto.ContainerType.OVERVIEW:
                            case com.mocity.rom.userevent.nano.LauncherLogProto.ContainerType.PREDICTION:
                            case com.mocity.rom.userevent.nano.LauncherLogProto.ContainerType.SEARCHRESULT:
                            case com.mocity.rom.userevent.nano.LauncherLogProto.ContainerType.DEEPSHORTCUTS:
                            case com.mocity.rom.userevent.nano.LauncherLogProto.ContainerType.PINITEM:
                    ...
                    case 64: {
                        int value = input.readInt32();
                        switch (value) {
                            case com.mocity.rom.userevent.nano.LauncherLogProto.ControlType.DEFAULT_CONTROLTYPE:
                            case com.mocity.rom.userevent.nano.LauncherLogProto.ControlType.ALL_APPS_BUTTON:
                            case com.mocity.rom.userevent.nano.LauncherLogProto.ControlType.WIDGETS_BUTTON:
                            case com.mocity.rom.userevent.nano.LauncherLogProto.ControlType.WALLPAPER_BUTTON:
                            case com.mocity.rom.userevent.nano.LauncherLogProto.ControlType.SETTINGS_BUTTON:
                            case com.mocity.rom.userevent.nano.LauncherLogProto.ControlType.REMOVE_TARGET:
                            case com.mocity.rom.userevent.nano.LauncherLogProto.ControlType.UNINSTALL_TARGET:
                            case com.mocity.rom.userevent.nano.LauncherLogProto.ControlType.APPINFO_TARGET:
                            case com.mocity.rom.userevent.nano.LauncherLogProto.ControlType.RESIZE_HANDLE:
                            case com.mocity.rom.userevent.nano.LauncherLogProto.ControlType.VERTICAL_SCROLL:
                            case com.mocity.rom.userevent.nano.LauncherLogProto.ControlType.HOME_INTENT:
                            case com.mocity.rom.userevent.nano.LauncherLogProto.ControlType.BACK_BUTTON:
                    ...
                    case 72: {
                        int value = input.readInt32();
                        switch (value) {
                            case com.mocity.rom.userevent.nano.LauncherLogProto.ItemType.DEFAULT_ITEMTYPE:
                            case com.mocity.rom.userevent.nano.LauncherLogProto.ItemType.APP_ICON:
                            case com.mocity.rom.userevent.nano.LauncherLogProto.ItemType.SHORTCUT:
                            case com.mocity.rom.userevent.nano.LauncherLogProto.ItemType.WIDGET:
                            case com.mocity.rom.userevent.nano.LauncherLogProto.ItemType.FOLDER_ICON:
                            case com.mocity.rom.userevent.nano.LauncherLogProto.ItemType.DEEPSHORTCUT:
                            case com.mocity.rom.userevent.nano.LauncherLogProto.ItemType.SEARCHBOX:
                            case com.mocity.rom.userevent.nano.LauncherLogProto.ItemType.EDITTEXT:
                            case com.mocity.rom.userevent.nano.LauncherLogProto.ItemType.NOTIFICATION:
                                this.itemType = value;
                                break;
                        }
                        break;
    ...
    public static final class Action extends
        ...
        public Action clear() {
            type = com.mocity.rom.userevent.nano.LauncherLogProto.Action.Type.TOUCH;
            touch = com.mocity.rom.userevent.nano.LauncherLogProto.Action.Touch.TAP;
            dir = com.mocity.rom.userevent.nano.LauncherLogProto.Action.Direction.NONE;
            command = com.mocity.rom.userevent.nano.LauncherLogProto.Action.Command.HOME_INTENT;
            isOutside = false;
            cachedSize = -1;
            return this;
        }
        ...
        public void writeTo(com.google.protobuf.nano.CodedOutputByteBufferNano output)
                throws java.io.IOException {
            if (this.type != com.mocity.rom.userevent.nano.LauncherLogProto.Action.Type.TOUCH) {
                output.writeInt32(1, this.type);
            }
            if (this.touch != com.mocity.rom.userevent.nano.LauncherLogProto.Action.Touch.TAP) {
                output.writeInt32(2, this.touch);
            }
            if (this.dir != com.mocity.rom.userevent.nano.LauncherLogProto.Action.Direction.NONE) {
                output.writeInt32(3, this.dir);
            }
            if (this.command != com.mocity.rom.userevent.nano.LauncherLogProto.Action.Command.HOME_INTENT) {
            ...
            while (true) {
                ...
                switch (tag) {
                    ...
                    case 8: {
                        int value = input.readInt32();
                        switch (value) {
                            case com.mocity.rom.userevent.nano.LauncherLogProto.Action.Type.TOUCH:
                            case com.mocity.rom.userevent.nano.LauncherLogProto.Action.Type.AUTOMATED:
                            case com.mocity.rom.userevent.nano.LauncherLogProto.Action.Type.COMMAND:
                                this.type = value;
                                break;
                        }
                        break;
                    ...
                    case 16: {
                        int value = input.readInt32();
                        switch (value) {
                            case com.mocity.rom.userevent.nano.LauncherLogProto.Action.Touch.TAP:
                            case com.mocity.rom.userevent.nano.LauncherLogProto.Action.Touch.LONGPRESS:
                            case com.mocity.rom.userevent.nano.LauncherLogProto.Action.Touch.DRAGDROP:
                            case com.mocity.rom.userevent.nano.LauncherLogProto.Action.Touch.SWIPE:
                            case com.mocity.rom.userevent.nano.LauncherLogProto.Action.Touch.FLING:
                            case com.mocity.rom.userevent.nano.LauncherLogProto.Action.Touch.PINCH:
                                this.touch = value;
                                break;
                        }
                        break;
                    ...
                    case 24: {
                        int value = input.readInt32();
                        switch (value) {
                            case com.mocity.rom.userevent.nano.LauncherLogProto.Action.Direction.NONE:
                            case com.mocity.rom.userevent.nano.LauncherLogProto.Action.Direction.UP:
                            case com.mocity.rom.userevent.nano.LauncherLogProto.Action.Direction.DOWN:
                            case com.mocity.rom.userevent.nano.LauncherLogProto.Action.Direction.LEFT:
                            case com.mocity.rom.userevent.nano.LauncherLogProto.Action.Direction.RIGHT:
                                this.dir = value;
                                break;
                        }
                        break;
                    ...
                    case 32: {
                        int value = input.readInt32();
                        switch (value) {
                            case com.mocity.rom.userevent.nano.LauncherLogProto.Action.Command.HOME_INTENT:
                            case com.mocity.rom.userevent.nano.LauncherLogProto.Action.Command.BACK:
                            case com.mocity.rom.userevent.nano.LauncherLogProto.Action.Command.ENTRY:
                            case com.mocity.rom.userevent.nano.LauncherLogProto.Action.Command.CANCEL:
                            case com.mocity.rom.userevent.nano.LauncherLogProto.Action.Command.CONFIRM:
                                this.command = value;
                                break;
                        }
                        break;
    ...
    public static final class LauncherEvent extends
        ...
        public com.mocity.rom.userevent.nano.LauncherLogProto.Action action;

        // repeated .userevent.Target src_target = 2;
        public com.mocity.rom.userevent.nano.LauncherLogProto.Target[] srcTarget;

        // repeated .userevent.Target dest_target = 3;
        public com.mocity.rom.userevent.nano.LauncherLogProto.Target[] destTarget;
        ...
        public LauncherEvent clear() {
            action = null;
            srcTarget = com.mocity.rom.userevent.nano.LauncherLogProto.Target.emptyArray();
            destTarget = com.mocity.rom.userevent.nano.LauncherLogProto.Target.emptyArray();
        ...
        public void writeTo(com.google.protobuf.nano.CodedOutputByteBufferNano output)
            ...
            if (this.srcTarget != null && this.srcTarget.length > 0) {
                for (int i = 0; i < this.srcTarget.length; i++) {
                    com.mocity.rom.userevent.nano.LauncherLogProto.Target element = this.srcTarget[i];
                    if (element != null) {
            ...
            if (this.destTarget != null && this.destTarget.length > 0) {
                for (int i = 0; i < this.destTarget.length; i++) {
                    com.mocity.rom.userevent.nano.LauncherLogProto.Target element = this.destTarget[i];
                    if (element != null) {
        ...
        public LauncherEvent mergeFrom(
            ...
            while (true) {
                ...
                switch (tag) {
                    ...
                    case 10: {
                        if (this.action == null) {
                            this.action = new com.mocity.rom.userevent.nano.LauncherLogProto.Action();
                        }
                    ...
                    case 18: {
                        ...
                        com.mocity.rom.userevent.nano.LauncherLogProto.Target[] newArray =
                                new com.mocity.rom.userevent.nano.LauncherLogProto.Target[i + arrayLength];
                        if (i != 0) {
                            java.lang.System.arraycopy(this.srcTarget, 0, newArray, 0, i);
                        }
                        for (; i < newArray.length - 1; i++) {
                            newArray[i] = new com.mocity.rom.userevent.nano.LauncherLogProto.Target();
