...
import com.mocity.rom.graphics.IconNormalizer;
    ...
    private void loadResourceIds() {
        try {
            ...
            if (metaData != null) {
                ...
                int bitmapResource = metaData.getInt("com.mocity.rom.LEVEL_PER_TICK_ICON", 0);
                this.layerDrawable = (LayerDrawable)cL(mContext, resourcesForApplication, bitmapResource);
                this.hourResource = metaData.getInt("com.mocity.rom.HOUR_LAYER_INDEX", -1);
                this.minuteResource = metaData.getInt("com.mocity.rom.MINUTE_LAYER_INDEX", -1);
                this.secondResource = metaData.getInt("com.mocity.rom.SECOND_LAYER_INDEX", -1);
